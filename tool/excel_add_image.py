    ...
    for w in range(1, width + 1):
        ...
        for h in range(1, height + 1):
            ...
            if h == 1:
                ...
                worksheet.column_dimensions[_w_letter].width = 2
                # openpyxl < 2.5.12
                # worksheet.column_dimensions[_w].width = 1
            # 调整行高
            worksheet.row_dimensions[h].height = 12
...
if __name__ == '__main__':
  print(os.path.dirname(__file__) + '/example.jpg')
  draw_jpg(os.path.dirname(__file__) + '/example.jpg')